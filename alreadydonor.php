...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Login </small></h1>
...
<div><textarea class="form-control" name="email"></textarea></div>
</div>
...
<div><textarea class="form-control" name="password"></textarea></div>
</div>
...
<div class="col-lg-4 mb-4">
    <div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="submit" class="btn btn-primary" value="login" style="cursor:pointer;position: relative;left: 330px;"></div>
</div>
...
$sql = "SELECT * from tblblooddonars where (status=:status and EmailId=:email) &&  (Password=:password)";
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        <h4 class="card-title"><a href="editdonor.php"><?php echo htmlentities($result->FullName);?></a></h4>
